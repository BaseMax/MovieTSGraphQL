...
export class MoviesResolver {
  constructor(private service: MoviesService, private commentsService: CommentsService) { }
  ...
  @ResolveField()
  comments(@Parent() movie: Movie, @Args("pagination") pagination: CursorBasedPagination, @AuthenticatedDec() user?: UserAuthPayload,) {
